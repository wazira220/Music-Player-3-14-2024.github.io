...
AudioMeteData[] playListMetaData;
//
...
void setup() {
  ...
  //
  //Font Code
  generalFont = createFont( "BodoniMT-italic", appHeight );
  //
  ...
  playListMetaData[0] = playList[0].get
 //
...
void draw() {
  ...
  int size = 28; //Change the number until it fits, largest font size
